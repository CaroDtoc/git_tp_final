<!-- Bienvenue dans le TP Final de git. Cette partie de l'exercice consiste en la présentation des différents membres de notre equipe. Il faut noter que sur le plan académique nous sommes tous des étudiants de CDWFS à l'institut unniversitaire de la cote.
Chef de projet : Donkeng Caroline
Collaborateur 1: NGOUNE Yann
Collaborateur 2: PAMBE Grace de Dieu
Collaborateur 3: WEPADJUE Hybrel
